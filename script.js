const translations = {
  is: {
    ...
    service_lines_desc: 'Nákvæm lína, fín smáatriði og góður frágangur.',
    service_hygiene: 'Hreinlæti',
    service_hygiene_desc: 'Fagleg vinnubrögð og hreinlætisstaðlar í hverju skrefi.',
    ...
    faq_pain_q: 'Er sársaukafullt að fá sér tattú?',
